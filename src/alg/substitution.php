...
function substitution(int $key, string $text, array $languages, string $type = 'encode')
{
    $res = '';
...
function cryptoSubstitution()
{
    ...
    switch ($method) {
        ...
        case '2':
            ...
            substitution($key, input(), $lang, 'decode');
            break;
